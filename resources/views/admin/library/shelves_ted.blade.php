...
@section('title', 'TED Shelves')
@section('header', 'Library - TED (Tertiary Education) Shelves')
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-4 px-6 text-center text-gray-400 italic">No TED shelves found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
