...
@section('title', 'Research Database - Elementary')
@section('header', 'Library - Research Database (Elementary)')
...
@section('content')
    ...
    <div class="card bg-white p-6 rounded-lg shadow-sm">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            <h3 class="text-gray-700 font-bold text-lg">Master List of Research &mdash; Elementary</h3>
