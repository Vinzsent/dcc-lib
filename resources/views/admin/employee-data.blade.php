            ...
            <form action="{{ route('admin.employee-data.store') }}" method="POST" class="p-6 sm:p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <select name="department" class="w-full border border-gray-300 rounded-lg px-3.5 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200">
